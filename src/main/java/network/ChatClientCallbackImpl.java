...
public class ChatClientCallbackImpl extends UnicastRemoteObject implements ChatClientCallback {
    ...
    @Override
    public void receivePrivateMessage(String senderNickname, String message) throws RemoteException {
        chatWindow.displayMessage("[Private from " + senderNickname + "] " + message);
    }
}